...
Public Class _3r_Venda

    'Declarem 7 variables de Llibres i Assignatures per a cada Llibre
    ...
    Private Sub _3r_Venda_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim consultaLlibres As String = "SELECT dataL.idDadesLlibre, dataL.idAssignatura, dataL.titolLlibre, dataL.subtitolLlibre, ed.nomEditorial, dataL.pvpVenda FROM DadesLlibre dataL INNER JOIN Editorials ed ON dataL.idEditorial = ed.idEditorial WHERE dataL.idCursLlibre = 300 And dataL.llibreActiu = True"
        ...
        If mydatatable.Rows.Count > 0 Then
            ...
            TxtB_PVP_5.Text = mydatatable.Rows(4).Item("pvpVenda")
            ...
            TxtB_PVP_6.Text = mydatatable.Rows(5).Item("pvpVenda")

            Llibre6 = mydatatable.Rows(6).Item("idDadesLlibre")
            Assignatura6 = mydatatable.Rows(6).Item("idAssignatura")
            TxtB_Llibre7S.Text = mydatatable.Rows(6).Item("titolLlibre") & ", " & mydatatable.Rows(6).Item("subtitolLlibre")
            TxtB_Editorial7S.Text = mydatatable.Rows(6).Item("nomEditorial")
            TxtB_PVP_7.Text = mydatatable.Rows(6).Item("pvpVenda")
        End If
        ...
        TxtB_Llibre7I.Text = TxtB_Llibre7S.Text
        ...
        TxtB_Editorial7I.Text = TxtB_Editorial7S.Text
        ...
        TxtB_PVP_7I.Text = TxtB_PVP_7.Text

        'Caldrà accedir a la Base de Dades per obtenir els alumnes del grup
        Dim consultaAlumnes As String = "SELECT al.idAlumne, al.nomAlumne, al.preuTotalRecollida FROM Alumnes al WHERE al.idCursVenda = 301 Or al.idCursVenda = 302"
    ...
    Private Sub ChkB_Llibre5S_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkB_Llibre5S.CheckedChanged
        ...
        ElseIf (ChkB_Llibre5S.Checked = False) Then
            ...
            Tick5.Visible = False                       'Desmarquem la casella del seu homònim inferior.
    ...
    Private Sub ChkB_Llibre6S_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkB_Llibre6S.CheckedChanged
        ...
        If (ChkB_Llibre6S.Checked = True) Then
            ...
            Tick6.Visible = True                        'Marquem la casella del seu homònim inferior.
        ...
        ElseIf (ChkB_Llibre6S.Checked = False) Then
            ...
            Tick6.Visible = False                       'Desmarquem la casella del seu homònim inferior.
    ...
    Private Sub ChkB_Llibre7S_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkB_Llibre7S.CheckedChanged
        ...
        If (ChkB_Llibre7S.Checked = True) Then
            ...
            Tick7.Visible = True                        'Marquem la casella del seu homònim inferior.
        ...
        ElseIf (ChkB_Llibre7S.Checked = False) Then
            ...
            Tick7.Visible = False                       'Desmarquem la casella del seu homònim inferior.
    ...
    Private Function comprovaLlibresVenutsAlumne() As Boolean
        ...
        If ChkB_Llibre5S.Checked = True Then
            'Li definim la consulta
            consultaLlibreNoPortats = "SELECT COUNT(Lli.idDadesLlibre) as res FROM Llibres Lli INNER JOIN LlibreAlumneVenda Lav ON Lli.idLlibre = Lav.idLlibre INNER JOIN Alumnes Al ON Lav.idAlumne = Al.idAlumne WHERE Al.idAlumne = " & idAlumne & " AND Lli.idDadesLlibre = " & Llibre4 & ""

            resCon = executaConsultaLlibres(consultaLlibreNoPortats)    'Executem la Funció de Consulta
            If resCon = 1 Then
                repetit = True
                MsgBox("El llibre de " & TxtB_Llibre5S.Text & " ja li ha estat venut, desmarca'l!")
            End If
        End If

        If ChkB_Llibre6S.Checked = True Then
            'Li definim la consulta
            consultaLlibreNoPortats = "SELECT COUNT(Lli.idDadesLlibre) as res FROM Llibres Lli INNER JOIN LlibreAlumneVenda Lav ON Lli.idLlibre = Lav.idLlibre INNER JOIN Alumnes Al ON Lav.idAlumne = Al.idAlumne WHERE Al.idAlumne = " & idAlumne & " AND Lli.idDadesLlibre = " & Llibre5 & ""

            resCon = executaConsultaLlibres(consultaLlibreNoPortats)    'Executem la Funció de Consulta
            If resCon = 1 Then
                repetit = True
                MsgBox("El llibre de " & TxtB_Llibre6S.Text & " ja li ha estat venut, desmarca'l!")
            End If
        End If

        If ChkB_Llibre7S.Checked = True Then
            'Li definim la consulta
            consultaLlibreNoPortats = "SELECT COUNT(Lli.idDadesLlibre) as res FROM Llibres Lli INNER JOIN LlibreAlumneVenda Lav ON Lli.idLlibre = Lav.idLlibre INNER JOIN Alumnes Al ON Lav.idAlumne = Al.idAlumne WHERE Al.idAlumne = " & idAlumne & " AND Lli.idDadesLlibre = " & Llibre6 & ""

            resCon = executaConsultaLlibres(consultaLlibreNoPortats)    'Executem la Funció de Consulta
            If resCon = 1 Then
                repetit = True
                MsgBox("El llibre de " & TxtB_Llibre7S.Text & " ja li ha estat venut, desmarca'l!")
            End If
        End If
    ...
    Private Function disponibilitatLlibres() As Boolean
        ...
        If ChkB_Llibre5S.Checked = True Then
            ...
            If Num_Llibre5S.Text = "" Then
                disponible = True
            Else
                numLlibre5 = Num_Llibre5S.Text          'Posem el número de llibre que requereix.
                'Preparem la consulta.
                Dim consultaDisponibilitatLlibre As String = "SELECT idEstatLlibre FROM Llibres WHERE idDadesLlibre = " & Llibre4 & " AND numLlibre = " & numLlibre5 & ""
                ...
                If resultat = 1 Then    'Ja està en Roda, per tant, ja se li ha fet entrega a algun alumne
                    disponible = False
                    MsgBox("El Llibre indicat de " & Llibre4 & "ja se li ha venut a un altre alumne, revisa les dades i/o canvia de Llibre!", MsgBoxStyle.Critical)
                ElseIf resultat = 2 Then    'Està en Revisió, per tant, és apte per vendre.
                    disponible = True
                ElseIf resultat = 3 Then
                    disponible = True
                ElseIf resultat = 4 Then
                    disponible = False
                    MsgBox("El Llibre indicat de " & Llibre4 & "ha estat cedit, revisa les dades i/o canvia de Llibre!", MsgBoxStyle.Critical)
                ElseIf resultat = 5 Then
                    disponible = True
                ElseIf resultat = 6 Then
                    disponible = False
                    MsgBox("El Llibre indicat de " & Llibre4 & "ha estat RETirat, revisa les dades i/o canvia de Llibre!", MsgBoxStyle.Critical)
                Else                'Aquest entra per si no hi ha hagut dades, això vol dir que el llibre és nou o no se'n disposa de cap dada. 
                    disponible = True
                End If
        ...
        If ChkB_Llibre6S.Checked = True Then
            ...
            If Num_Llibre6S.Text = "" Then
                disponible = True
            Else
                numLlibre6 = Num_Llibre6S.Text          'Posem el número de llibre que requereix.
                'Preparem la consulta.
                Dim consultaDisponibilitatLlibre As String = "SELECT idEstatLlibre FROM Llibres WHERE idDadesLlibre = " & Llibre5 & " AND numLlibre = " & numLlibre6 & ""
                ...
                If resultat = 1 Then    'Ja està en Roda, per tant, ja se li ha fet entrega a algun alumne
                    disponible = False
                    MsgBox("El Llibre indicat de " & Llibre5 & "ja se li ha venut a un altre alumne, revisa les dades i/o canvia de Llibre!", MsgBoxStyle.Critical)
                ElseIf resultat = 2 Then    'Està en Revisió, per tant, és apte per vendre.
                    disponible = True
                ElseIf resultat = 3 Then
                    disponible = True
                ElseIf resultat = 4 Then
                    disponible = False
                    MsgBox("El Llibre indicat de " & Llibre5 & "ha estat cedit, revisa les dades i/o canvia de Llibre!", MsgBoxStyle.Critical)
                ElseIf resultat = 5 Then
                    disponible = True
                ElseIf resultat = 6 Then
                    disponible = False
                    MsgBox("El Llibre indicat de " & Llibre5 & "ha estat RETirat, revisa les dades i/o canvia de Llibre!", MsgBoxStyle.Critical)
                Else                'Aquest entra per si no hi ha hagut dades, això vol dir que el llibre és nou o no se'n disposa de cap dada. 
                    disponible = True
                End If
        ...
        If ChkB_Llibre7S.Checked = True Then
            ...
            Dim numLlibre7 As String    'Hi desem el número de Llibre del TextBox

            If Num_Llibre7S.Text = "" Then
                disponible = True
            Else
                numLlibre7 = Num_Llibre7S.Text          'Posem el número de llibre que requereix.
                'Preparem la consulta.
                Dim consultaDisponibilitatLlibre As String = "SELECT idEstatLlibre FROM Llibres WHERE idDadesLlibre = " & Llibre6 & " AND numLlibre = " & numLlibre7 & ""
                ...
                If resultat = 1 Then    'Ja està en Roda, per tant, ja se li ha fet entrega a algun alumne
                    disponible = False
                    MsgBox("El Llibre indicat de " & Llibre6 & "ja se li ha venut a un altre alumne, revisa les dades i/o canvia de Llibre!", MsgBoxStyle.Critical)
                ElseIf resultat = 2 Then    'Està en Revisió, per tant, és apte per vendre.
                    disponible = True
                ElseIf resultat = 3 Then
                    disponible = True
                ElseIf resultat = 4 Then
                    disponible = False
                    MsgBox("El Llibre indicat de " & Llibre6 & "ha estat cedit, revisa les dades i/o canvia de Llibre!", MsgBoxStyle.Critical)
                ElseIf resultat = 5 Then
                    disponible = True
                ElseIf resultat = 6 Then
                    disponible = False
                    MsgBox("El Llibre indicat de " & Llibre6 & "ha estat RETirat, revisa les dades i/o canvia de Llibre!", MsgBoxStyle.Critical)
                Else                'Aquest entra per si no hi ha hagut dades, això vol dir que el llibre és nou o no se'n disposa de cap dada. 
                    disponible = True
                End If
    ...
    Private Function distribueixLlibres() As Boolean
        ...
        If ChkB_Llibre5S.Checked = True Then
            ...
            If existeix = True Then
                'Escrivim la consulta amb un UPDATE per a canviar les dades.
                Dim UpdateDadesLlibre As String = "UPDATE Llibres SET idEstatLlibre = 1, llibreActualitzat = CURRENT_TIMESTAMP WHERE idDadesLlibre = " & Llibre4 & " AND numLlibre = " & numLlibre5 & ""
                ...
                End If
            ElseIf existeix = False Then
                Dim InsertDadesLlibre As String = "INSERT INTO Llibres (idDadesLlibre, numLlibre, idEstatLlibre, llibreActualitzat) VALUES (" & Llibre4 & ", " & numLlibre5 & ", 1, CURRENT_TIMESTAMP)"
        ...
        If ChkB_Llibre6S.Checked = True Then
            ...
            If existeix = True Then
                'Escrivim la consulta amb un UPDATE per a canviar les dades.
                Dim UpdateDadesLlibre As String = "UPDATE Llibres SET idEstatLlibre = 1, llibreActualitzat = CURRENT_TIMESTAMP WHERE idDadesLlibre = " & Llibre5 & " AND numLlibre = " & numLlibre6 & ""
                ...
                End If
            ElseIf existeix = False Then
                Dim InsertDadesLlibre As String = "INSERT INTO Llibres (idDadesLlibre, numLlibre, idEstatLlibre, llibreActualitzat) VALUES (" & Llibre5 & ", " & numLlibre6 & ", 1, CURRENT_TIMESTAMP)"
        ...
        If ChkB_Llibre7S.Checked = True Then
            ...
            If Num_Llibre7S.Text = "" Then  'Obtenim el Valor del Número de Llibre del TextBox Corresponent a la fila del CHKBox1
                numLlibre7 = assignaNumero(Llibre6)
            Else
                numLlibre7 = Num_Llibre7S.Text
            End If

            'Cal comprovar que el llibre existeix amb una consulta
            Dim consultaExistenciaLlibre As String = "SELECT COUNT( Lli.numLlibre ) AS res FROM Llibres Lli WHERE Lli.idDadesLlibre = " & Llibre6 & " AND Lli.numLlibre = " & numLlibre7 & ""
            existeix = consultaExistencia(consultaExistenciaLlibre)

            'MsgBox("Resultat de la consulta de l'existència del llibre " & numLlibre7 & ": " & existeix)
            ...
            If existeix = True Then
                'Escrivim la consulta amb un UPDATE per a canviar les dades.
                Dim UpdateDadesLlibre As String = "UPDATE Llibres SET idEstatLlibre = 1, llibreActualitzat = CURRENT_TIMESTAMP WHERE idDadesLlibre = " & Llibre6 & " AND numLlibre = " & numLlibre7 & ""

                'Cridem al mètode per a fer l'Update
                executaModificacioLlibre(UpdateDadesLlibre)
                consultaIDLlibre = comprovaModificacioLlibre(Llibre6, numLlibre7)
                ...
                End If
            ElseIf existeix = False Then
                Dim InsertDadesLlibre As String = "INSERT INTO Llibres (idDadesLlibre, numLlibre, idEstatLlibre, llibreActualitzat) VALUES (" & Llibre6 & ", " & numLlibre7 & ", 1, CURRENT_TIMESTAMP)"

                'Cridem al mètode per a fer l'Insert
                ultimID = executaInsercioLlibre(InsertDadesLlibre, Llibre6, numLlibre7)
                consultaIDLlibre = comprovaModificacioLlibre(Llibre6, numLlibre7)
