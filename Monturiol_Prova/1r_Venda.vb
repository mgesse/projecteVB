...
Public Class _1r_Venda
    ...
    Private Sub _1r_Venda_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim consultaAlumnes As String = "SELECT al.idAlumne, al.nomAlumne, al.preuTotalRecollida FROM Alumnes al WHERE al.idCursVenda = 101 Or al.idCursVenda = 102"
