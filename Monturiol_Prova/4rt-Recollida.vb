...
Public Class _4rt_Recollida
    'Declarem 4 variables de Llibres, que emmagatemaràn l'ID de DadesLlibre. A 4rt d'ESO en necessitem 4!!
    ...
    Private Sub _4rt_Recollida_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        TxtB_Data.Text = Date.Now.Date
        TxtBox_Data_Inf.Text = Date.Now.Date

        Dim consultaLlibres As String = "SELECT dataL.idDadesLlibre, dataL.idAssignatura, dataL.titolLlibre, dataL.subtitolLlibre, ed.nomEditorial, dataL.pvpRecollida FROM DadesLlibre dataL INNER JOIN Editorials ed ON dataL.idEditorial = ed.idEditorial WHERE dataL.idCursLlibre = 400 And dataL.llibreActiu = True"
        ...
        Dim consultaAlumnes As String = "SELECT al.idAlumne, al.nomAlumne FROM Alumnes al WHERE al.idCursRecollida = 401 Or al.idCursRecollida = 402 Or al.idCursRecollida = 403"
