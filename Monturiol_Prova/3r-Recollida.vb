...
Public Class Recollida3r

    'Declarem 7 variables de Llibres, que emmagatemaràn l'ID de DadesLlibre. A 3r d'ESO en necessitem 7!!
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim consultaLlibres As String = "SELECT dataL.idDadesLlibre, dataL.idAssignatura, dataL.titolLlibre, dataL.subtitolLlibre, ed.nomEditorial, dataL.pvpRecollida FROM DadesLlibre dataL INNER JOIN Editorials ed ON dataL.idEditorial = ed.idEditorial WHERE dataL.idCursLlibre = 300 And dataL.llibreActiu = True"
        ...
        If mydatatable.Rows.Count > 0 Then
            ...
            TxtB_PVP_7.Text = mydatatable.Rows(6).Item("pvpRecollida")
        End If
        ...
        Dim consultaAlumnes As String = "SELECT al.idAlumne, al.nomAlumne FROM Alumnes al WHERE al.idCursRecollida = 301 Or al.idCursRecollida = 302"
    ...
    Private Function comprovaLlibresNoPortats() As Boolean
        ...
        If ChkB_Llibre7S.Checked = True Then
            'Li definim la consulta
            consultaLlibreNoPortats = "SELECT COUNT(Lli.idDadesLlibre) as res FROM Llibres Lli INNER JOIN LlibreAlumneRecollida Lar ON Lli.idLlibre = Lar.idLlibre INNER JOIN Alumnes Al ON Lar.idAlumne = Al.idAlumne WHERE Al.idAlumne = " & idAlumne & " AND Lli.idDadesLlibre = " & Llibre6 & ""

            resCon = executaConsultaLlibres(consultaLlibreNoPortats)    'Executem la Funció de Consulta
            If resCon = 1 Then
                repetit = True
                MsgBox("El llibre de " & TxtB_Llibre7S.Text & " ja ha estat entregat, desmarca'l!")
            End If
        End If
    ...
    Private Function comprovaNumeroLlibres() As Boolean
        ...
        If ChkB_Llibre7S.Checked = True Then
            Dim numLlibre7 As String
            'Obtenim el Valor del Número del TextBox Corresponent a la fila del CHKBox7
            ...
            'Li definim la consulta
            consultaLlibreNumero = "Select Lli.idEstatLlibre FROM Llibres Lli INNER JOIN EstatLlibres Est ON Lli.idEstatLlibre = Est.idEstatLlibres WHERE Lli.idDadesLlibre = " & Llibre6 & " AND Lli.numLlibre = '" & numLlibre7 & "'"
            ...
            'Fem que ens validi el missatge
            repetit = mostraMissatgeNumLlibre(numLlibre7, resCon, TxtB_Llibre7S.Text, repetit)
    ...
    Private Function distribueixLlibres() As Boolean
        ...
        If ChkB_Llibre7S.Checked = True Then
            ...
            If existeix = True Then
                'Escrivim la consulta amb un UPDATE per a canviar les dades.
                Dim UpdateDadesLlibre As String = "UPDATE Llibres SET idEstatLlibre = 2, llibreActualitzat = CURRENT_TIMESTAMP WHERE idDadesLlibre = " & Llibre6 & " AND numLlibre = " & numLlibre7 & ""
                ...
                End If
            ElseIf existeix = False Then
                Dim InsertDadesLlibre As String = "INSERT INTO Llibres (idDadesLlibre, numLlibre, idEstatLlibre, llibreActualitzat) VALUES (" & Llibre6 & ", " & numLlibre7 & ", 2, CURRENT_TIMESTAMP)"
    ...
    'Mètode per a Imprimir un document de prova SENSE DESAR A BBDD.
    Private Sub ImprimeixUnComprovantDeProvaToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    'Mètode per a Validar les dades a la BBDD pero SENSE IMPRIMIR.
    Private Sub VàlidaLesDadesSenseImprimirToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    'Mètode per a tancar l'Aplicació i tornar al menú.
    Private Sub TornaEnrereToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Close()
    End Sub

    'Mètode per a informar amb un message box sobre el form actual
    Private Sub CrèditsToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
