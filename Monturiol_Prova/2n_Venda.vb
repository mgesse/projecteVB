...
Public Class _2n_Venda
    ...
    Private Sub _2n_Venda_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim consultaLlibres As String = "SELECT dataL.idDadesLlibre, dataL.idAssignatura, dataL.titolLlibre, dataL.subtitolLlibre, ed.nomEditorial, dataL.pvpVenda FROM DadesLlibre dataL INNER JOIN Editorials ed ON dataL.idEditorial = ed.idEditorial WHERE dataL.idCursLlibre = 100 And dataL.llibreActiu = True"
        ...
        Dim consultaAlumnes As String = "SELECT al.idAlumne, al.nomAlumne, al.preuTotalRecollida FROM Alumnes al WHERE al.idCursVenda = 201 Or al.idCursVenda = 202"
